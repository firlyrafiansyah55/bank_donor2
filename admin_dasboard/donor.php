...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <h2>Hello, <span style="color: blue"> <?php echo $_SESSION['username']?></span> Manage Donors Here. </h2>
            <br />
            <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#adddonor">Add
                    new</button></p> <br />
      ...
      while($row = $members->fetch_array()) {
       ?>
                    ...
                    <tr>
                        ...
                        <td><?php if($row['image'] == ''){ ?>
                            <img src="http://wiki.bdtnrm.org.au/images/8/8d/Empty_profile.jpg" width="30px"
                                height="30px">
                            <?php   } else { ?>
                        ...
                        <td><button type="button" data-toggle="modal"
                                data-target="#deletdonor<?php echo $row['donor_id']?>"
                                class="btn btn-danger">Delete</button>
                            <button type="button" data-toggle="modal"
                                data-target="#editdonor<?php echo $row['donor_id'];?>"
                                class="btn btn-warning">Edit</button>


                            <button type="button" class="btn btn-default" data-toggle="modal"
                                data-target="#active<?php echo $row['donor_id']?>"
                                <?php if($row['status'] == '1') { echo 'disabled'; }?>><?php
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delete_donor.php?donor_id=<?php echo $row['donor_id'];?>"> <button
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="edit_status.php?status_id=<?php echo $row['donor_id']?>"
                                        method="post">
                ...
                <form action="add_donor.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="fathername" id="fathername"
                            placeholder="Enter fathername"></input>
                    </div>
