    ...
    <div id="wrapper">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="" data-toggle="modal" data-target="#logout"><i class="lnr lnr-exit"></i>
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="admin_dashboard.php" class="active"><i class="lnr lnr-home"></i>
                        ...
                        <li><a href="donor.php" class=""><i class="lnr lnr-alarm"></i> <span>Non Active
                                    Donors</span></a></li>
                        <li>

                        <li><a href="active_donors.php" class=""><i class="lnr lnr-alarm"></i> <span>Active
                                    Donors</span></a></li>
                        <li><a href="requested.php" class=""><i class="lnr lnr-code"></i> <span>Requested
                                    Donors</span></a></li>
